        ...
        <>
          ...
          <motion.div
            ...
            className={cn(
              ...
              "bg-void border border-graphite rounded-xl shadow-2xl",
              sizeStyles[size],
              className
            )}
          >
            {title && (
              <div className="flex items-center justify-between p-6 border-b border-graphite">
                <h2 className="font-[family-name:var(--font-display)] text-xl font-semibold text-marble">
                  {title}
                </h2>
                <button
                  onClick={onClose}
                  className="text-stone hover:text-champagne transition-colors p-1"
                >
                  <X className="w-5 h-5" />
                </button>
              </div>
